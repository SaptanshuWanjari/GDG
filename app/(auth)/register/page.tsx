...
import { Sparkles, Gift, Clock, Globe } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="flex min-h-screen">
        ...
        {/* Right side - Benefits and content */}
        <div className="hidden lg:flex justify-center lg:w-1/2 relative ">
          <div className="absolute inset-0 bg-black/10"></div>
          <div className="relative z-10 flex flex-col justify-center items-center p-12 text-secondary-foreground">
            <BiBookBookmark
              size={120}
              className="mb-8 text-secondary-foreground/90"
            />
            ...
            <p className="text-lg text-center mb-12 text-secondary-foreground/90 max-w-md">
              Join thousands of book lovers and discover your next favorite
              story in our vast digital library.
            </p>

            {/* Benefits */}
            <div className="grid grid-cols-1 gap-6 max-w-sm">
              <div className="flex items-center gap-4 text-secondary-foreground/90">
                <Sparkles className="h-8 w-8 bg-secondary-foreground/20 p-1.5 rounded-lg" />
                <div>
              ...
              <div className="flex items-center gap-4 text-secondary-foreground/90">
                <Gift className="h-8 w-8 bg-secondary-foreground/20 p-1.5 rounded-lg" />
                <div>
              ...
              <div className="flex items-center gap-4 text-secondary-foreground/90">
                <Clock className="h-8 w-8 bg-secondary-foreground/20 p-1.5 rounded-lg" />
                <div>
              ...
              <div className="flex items-center gap-4 text-secondary-foreground/90">
                <Globe className="h-8 w-8 bg-secondary-foreground/20 p-1.5 rounded-lg" />
                <div>
            ...
            <div className="mt-12 text-center">
              <p className="text-secondary-foreground/70 text-sm">
                Join over 10,000+ readers already exploring our library
              </p>
            </div>
          </div>
        </div>
