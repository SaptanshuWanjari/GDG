              ...
              {!isLoggedIn ? (
                <>
                  <Button
                    size="lg"
                    asChild
                    className="bg-background text-foreground hover:bg-primary-foreground hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-primary-foreground/25 px-8 py-4 text-lg font-semibold"
                  >
